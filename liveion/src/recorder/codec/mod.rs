...
/// Unified RTP parser trait so that different codecs (H264/Opus/â€? share the same faÃ§ade.
///
/// Associated type `Output` represents the parsed unit â€?for video it could be
