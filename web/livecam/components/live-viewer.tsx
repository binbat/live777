    ...
    return (
        <div className="bg-base-300 rounded-lg overflow-hidden shadow-lg">
            <div className="relative aspect-video">
                ...
                />
                <div
                    className={`absolute inset-0 flex items-center justify-center bg-black bg-opacity-60 transition-opacity duration-300 ${isConnected && isVisible ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}
                >
                    {!isVisible && (
            ...
            <div className="p-4 bg-base-200 flex items-center justify-between">
                <div>
                    <p className="font-bold truncate" title={streamId}>
