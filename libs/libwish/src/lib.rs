...
mod tests {
    ...
    fn test_from_http_response() {
        let response = Builder::new()
            ...
            .header(header::LINK, r#"<turn:turn.22333.fun>; rel="ice-server"; username="live777_username"; credential="live777_password""#)
            .body("")
            .unwrap();
        ...
        assert_eq!(ice_servers.get(2).unwrap().username, "live777_username");
        assert_eq!(ice_servers.get(2).unwrap().credential, "live777_password");
    }
}
